<template>
    <div>
        <section class="bg-[#f3f6fd] pt-[118px] pb-[120px] px-0">
            <div
                        ...
                        <div>
                            <div class="text-center mb-10">
                                ...
                                <p class="inline-block text-[#333333]">
                                    There are lots of online dating sites available which makes it difficult to choose the
                                    one which can give you a serious partner....
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-1/4 md:w-1/2 pr-4 pl-4">
                        <div
                            class="bg-white text-center transition-all duration-[ease] delay-[0.3s] pt-10 pb-5 px-[30px] rounded-[10px] hover:translate-y-[-5px] hover:shadow-[0.872px_9.962px_20px_0px_rgba(12,78,165,0.1)]">
                            <div class="relative inline-block mb-8">
                                <img src="@/assets/frontend/images/e-c-u/icon1.png" alt="">
                            </div>
                            <h4 class="text-2xl leading-[34px] font-bold mb-[19px]">
                                Dating
                            </h4>
                            <p>
