<template>
    <div>
        <section class="bg-[#f3f6fd] dark:bg-[#262950] pt-[118px] pb-[120px] px-0">
            <div
                    ...
                    <div class="lg:w-1/2 pr-4 pl-4">
                        <div>
                            <div class="text-center mb-10">
                                <h6 class="dark:text-[white] sub-title text-[#5650ce] block text-2xl leading-[34px] font-semibold mb-6">
                                    How We’re different
                                </h6>
