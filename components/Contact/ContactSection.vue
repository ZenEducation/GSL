<template>
    <div>
        <section class="relative pt-[118px] pb-[120px] px-0">
            <img class="absolute left-0 top-[35%]" src="@/assets/frontend/images/contact/img-left.png" alt="">
            <img class="absolute right-0 top-[30%]" src="@/assets/frontend/images/contact/img-right.png" alt="">
            <div
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-3/5 pr-4 pl-4">
                        <div>
                            ...
                            <div class="relative mb-[30px]">
                                <i style="display: grid; place-content: center;"
                                    class="far fa-envelope absolute -translate-y-2/4 bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] w-[30px] h-[30px] text-center leading-[30px] text-white text-sm rounded-[50%] top-2/4"></i>
                                <input type="text" placeholder="Enter Your Email ID"
                                    class="h-[50px] pl-[49px] pr-5 py-0 rounded-none border-t-0 border-b-[rgba(0,0,0,0.1)] border-x-0 border-b border-solid placeholder:text-[#8790ad] placeholder:text-base">
                            </div>
                            <div class="relative mb-[30px]">
                                <i style="display: grid; place-content: center;"
                                    class="far fa-comments absolute -translate-y-2/4 bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] w-[30px] h-[30px] text-center leading-[30px] text-white text-sm rounded-[50%] top-2/4"></i>
                                <textarea placeholder="Type Your Text"
                                    class="h-[260px] bg-[none] mt-1.5 pl-[49px] pr-5 p-0 rounded-none border-t-0 border-b-[rgba(0,0,0,0.1)] border-x-0 border-b border-solid placeholder:text-[#8790ad] placeholder:text-base"></textarea>
                            </div>
                            <NuxtLink to="#"
                                class=" no-underline uppercase bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] shadow-[0.872px_9.962px_20px_0px_rgba(12,78,165,0.3)] font-semibold text-white inline-block cursor-pointer w-auto h-auto px-[35px] py-[11px] rounded-[50px] border-0 hover:text-white hover:shadow-[1px_10px_20px_0px_rgba(12,78,165,0.43)]">
                                Submit</NuxtLink>
                        </div>
                    </div>
                </div>
