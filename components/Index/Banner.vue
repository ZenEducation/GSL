<template>
    <div>
        <section
            ...
            <img class="absolute leftRight right-0 top-0"
                src="@/assets/frontend/images/banner/aimg1.png" alt="">
            <img class="absolute upDown right-[17%] bottom-0"
                ...
                <div class="flex flex-wrap ">
                    <div class="xl:w-1/3 lg:w-2/5 pr-4 pl-4">
                        ...
                        <div
                            ...
                            <div
                                class="flex pt-[22px] pb-[15px] border-b-[rgba(0,0,0,0.1)] border-b border-solid px-5 py-[17px]">
                            ...
                            <div class="flex  border-b-[rgba(0,0,0,0.1)] border-b border-solid pt-[21px] pb-5 px-5">
                                ...
                                <div class="flex items-center">
                                    <div class="mr-3">
                                        <select
                                            class="w-[90px] bg-transparent leading-[26px] border h-auto pl-[15px] pr-[30px] py-0 rounded-[50px] border-solid border-[rgba(0,0,0,0.1)]">
                            ...
                            <div class="flex  border-b-[rgba(0,0,0,0.1)] border-solid pt-[29px] pb-7 px-5 border-b-0">
                                ...
                                <div class="items-center">
                                    <div class="s-input mr-3">
                                        <select
                                            class="select-bar w-[190px] px-2.5 bg-transparent leading-[26px] border h-auto pl-[15px] pr-[30px] py-0 rounded-[50px] border-solid border-[rgba(0,0,0,0.1)]">
