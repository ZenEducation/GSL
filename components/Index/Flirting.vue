                ...
                <div class="flex flex-wrap ">
                        ...
                        <div class="text-left">
                            <div class="text-left mb-[59px]">
                                ...
                                <p class="text-left">
                                    ...
                                    way to connect with others who share your interests and goals. If you're looking to
                                    start
                    ...
                    <div class="lg:w-1/2 pr-4 pl-4 self-center">
                        <div class="text-center relative px-[30px] py-0">
                            ...
                            <img class="w-full scaleAni" src="@/assets/frontend/images/flirting/illutration.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
