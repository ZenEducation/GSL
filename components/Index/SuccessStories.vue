            ...
            <div
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-1/3 md:w-1/2 pr-4 pl-4">
                        <div class="bg-white overflow-hidden transition-all duration-[ease] delay-[0.3s] rounded-[22px] hover:shadow-[0px_10px_50px_0px_rgb(176,164,226)]"
                            data-wow-delay="0.1s">
                            <div>
                            ...
                            <div
                                class="flex justify-between pt-5 pb-[18px] px-[30px] border-t-[rgba(0,0,0,0.1)] border-t border-solid">
                                <div>
                                    <ul>
                                        <li class="inline-block mr-[5px]">
                                            <NuxtLink to="#" class="block text-base no-underline">
                                                <i
                                                    class="fab fa-facebook-f bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] shadow-[0.927px_2.853px_10px_rgba(18,_72,_142,_0.5)]"></i>
                                            </NuxtLink>
                                        </li>
                                        <li class="inline-block mr-[5px]">
                                            <NuxtLink to="#" class="block text-base no-underline">
                                                <i
                                                    class="fab fa-twitter bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] shadow-[0.927px_2.853px_10px_rgba(18,_72,_142,_0.5)]"></i>
                                            </NuxtLink>
                                        </li>
                                        <li class="inline-block mr-0 ">
                                            <NuxtLink to="#" class="block text-base no-underline">
                                                <i
                                                    class="fab fa-instagram bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] shadow-[0.927px_2.853px_10px_rgba(18,_72,_142,_0.5)]"></i>
                                            </NuxtLink>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    <NuxtLink to="#"
                                        class="text-[#333333] text-sm transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] no-underline">
