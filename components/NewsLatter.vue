    ...
    <div>
        ...
        <div class="w-full px-[15px] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1170px] mx-auto sm:px-4">
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-1/4 sm:w-1/2 pr-4 pl-4">
                        <div>
                            ...
                            <ul>
                                <li>
                                    <NuxtLink href="/about" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> About Us
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/contact" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                ...
                                <li>
                                    <NuxtLink href="#" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Customer Reviews
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="#" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Success Stories
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="#" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Business License
                                    </NuxtLink>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="lg:w-1/4 sm:w-1/2 pr-4 pl-4">
                        <div>
                            ...
                            <ul>
                                <li>
                                    <NuxtLink href="/userPanel" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                ...
                                <li>
                                    <NuxtLink href="#" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Account Varification
                                    </NuxtLink>
                                </li>
                                <li>
                                ...
                                <li>
                                    <NuxtLink href="/membership" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                    ...
                    <div class="lg:w-1/4 sm:w-1/2 pr-4 pl-4">
                        <div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <NuxtLink href="/faqs" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> FAQ
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/quick_start" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i>Quick Start Guide
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="#" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i>Tutorials
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="#" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i>Associate Blog
                                    </NuxtLink>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="lg:w-1/4 sm:w-1/2 pr-4 pl-4">
                        <div>
                            ...
                            <ul>
                                <li>
                                    <NuxtLink href="/privacy_policy" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Privacy policy
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/end_user" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> End User Agreements
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/refund_policy" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Refund Policy
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/cookie_policy" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
                                        <i class="fas fa-angle-double-right text-base mr-[5px]"></i> Cookie policy
                                    </NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/report" class="text-white transition-all duration-[ease] delay-[0.3s] hover:text-[#eb1436] hover:pl-2.5 no-underline">
            ...
            <div>
                <div class="flex flex-wrap ">
                    <div class="lg:w-full pr-4 pl-4">
                        <hr class="hr2 mt-[108px] mb-6 mx-0 border-t-[rgba(255,255,255,0.2)] border-t border-solid">
                    </div>
                </div>
                <div class="flex flex-wrap ">
                    <div class="lg:w-1/2 pr-4 pl-4 self-center">
                        <div class="text-white">
                            ...
                            <NuxtLink href="/" class="text-[#eb1436] no-underline">GSL</NuxtLink>
                        </div>
                    </div>
                    <div class="lg:w-1/2 pr-4 pl-4">
                        <ul class="block text-right">
                            ...
                            <li class="inline-block ml-3.5">
                                <NuxtLink href="/" class="w-[50px] h-[50px] flex justify-center items-center text-white leading-[50px] text-center rounded-[50%] bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)]">
