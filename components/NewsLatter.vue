                        ...
                        <div>
                            <div class="flex justify-center items-center flex-col mt-[30px]">
                                ...
                                <form class="relative mt-[55px]">
                                    ...
                                    <button type="submit" class="absolute w-11 h-11 text-white text-[22px] mx-1 leading-[44px] rounded-[50%] right-[3px] top-[3px] bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)]">
                                        <Icon icon="la:telegram-plane" class="text-white" />
                                    </button>
                                </form>
                            </div>
                        </div>
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-1/2 pr-4 pl-4 self-center">
                        <div class="text-white">
                            ...
                            <a href="#" class="text-[#eb1436] no-underline">Peyamba</a>
                        </div>
                    </div>
                    <div class="lg:w-1/2 pr-4 pl-4">
                        <ul class="block text-right">
                            <li class="inline-block ml-0">
                                <a href="#" class="w-[50px] h-[50px] block text-white leading-[50px] text-center rounded-[50%] bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)]">
