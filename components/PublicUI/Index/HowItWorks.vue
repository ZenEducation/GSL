<template>
    <div>
        <section
            class="bg-[url(../images/h-it-w/bg-img.jpg)] bg-no-repeat bg-center bg-cover relative overflow-hidden pt-[118px] pb-[120px] px-0">
            <img class="absolute animate-[scaleAni_4s_linear_infinite] right-0 top-[100px]"
                src="@/assets/frontend/images/h-it-w/circle-shape.png" alt="">
            <img class="absolute animate-[upDown_3s_linear_infinite] right-[7%] top-[10%]"
                src="@/assets/frontend/images/h-it-w/bird.png" alt="">
            <div
                    ...
                    <div class="lg:w-1/3 md:w-1/2 max-md:w-full mb-12 pr-4 pl-4">
                        <div class=" bg-white dark:bg-[#262950] shadow-[0.872px_9.962px_20px_0px_rgba(12,78,165,0.3)] text-center transition-all duration-[ease] delay-[0.3s] px-[30px] py-10 rounded-[20px] hover:translate-y-[-5px]"
                            ...
                            <div class=" relative inline-block mb-[34px]">
                                ...
                                <div
                                    class=" absolute w-[60px] h-[60px] text-white text-[28px] leading-[60px] font-semibold bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] rounded-[50%] right-5 bottom-0">
                                    01
                                </div>
                            </div>
