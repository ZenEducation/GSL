<template>
    <div>
        <section class="overflow-hidden px-0 py-[118px]  dark:bg-[#202342] dark:text-gray-50">
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-full pr-4 pl-4">
                        <div class="mb-[-140px] relative z-[9] mt-0">
                            <img class=" absolute left-[-120px] top-0"
                                src="@/assets/frontend/images/membership/left-img.png" alt="">
                            <img class=" absolute right-[-260px] top-0"
                                src="@/assets/frontend/images/membership/right-img.png" alt="">
                            <div class="flex flex-wrap ">
                                <div class="lg:w-1/4 md:w-1/2 pr-4 pl-4">
                                    <div
            ...
            <img class="absolute w-full h-auto animate-[scaleAni_4s_linear_infinite] left-0 top-0"
                src="@/assets/frontend/images/join/heartshape.png" alt="">
            <div
                ...
                <div class="flex flex-wrap ">
                    <div class="lg:w-full pr-4 pl-4">
                        <p class="text-2xl leading-[34px] font-normal text-white">
                            If you have any questions <a href="#" class="font-semibold text-[#ff3366] underline">Contact
                                Us</a>
                        </p>
                    </div>
                </div>
