            ...
            <div
                ...
                <div class="header-wrapper  flex flex-wrap justify-between items-center">
                    ...
                    <ul class="menu active overflow-hidden"  v-if="menuOpen" >
                        ...
                        <li>
                            <NuxtLink href="/PublicUI/community">Community</NuxtLink>
                            <ul class="submenu" style="display: block;"  >
                                <li>
                                    <NuxtLink href="/PublicUI/communitySingle">Community Single</NuxtLink>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <NuxtLink href="membership">Membership</NuxtLink>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <NuxtLink href="/PublicUI/blog">Blog</NuxtLink>
                                </li>
                            </ul>
                        </li>
                        <li >
                            <NuxtLink href="/PublicUI/blogsingle">Blog Single</NuxtLink>
                        ...
                        <li class="user-profile">
                            ...
                            <ul class="submenu" style="display: block;"  >
                                <li>
                                    <NuxtLink href="/PublicUI/singleprofile">Profile</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/PublicUI/UserPanel">User Panel</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/PublicUI/login">Login</NuxtLink>
                                </li>
                                <li>
                                    <NuxtLink href="/PublicUI/register">Register</NuxtLink>
                                </li>
                                <li>
                    ...
                    <ul
                        ...
                        <li>
                            <NuxtLink href="#" class="min-[992px]:flex min-[992px]:items-center">
