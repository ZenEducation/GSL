                            ...
                            <div>
                                <form action="#">
                                    ...
                                    <div class="block text-center">
                                        ...
                                        <NuxtLink to="#" class=" no-underline border bg-[rgb(234,242,252)] dark:bg-[#262950]  shadow-[1.948px_13.864px_6px_0px_rgba(220,234,251,0.3)] transition-all duration-[ease] delay-[0.3s] mt-[9px] mb-[19px] px-[30px] py-2.5 rounded-[50px] border-solid border-[rgba(59,54,140,0.1)] hover:shadow-[2px_13px_16px_0px_rgba(59,54,140,0.1)]"><img src="" class="mr-2" alt=""> Sign Up with
                                            Google</NuxtLink>
                                        <p class="text-base">
