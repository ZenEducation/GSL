    ...
    <div data-spy="scroll" data-target=".fixed-top">
        ...
        <nav class="navbar fixed-top">
            <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
                ...
                <!-- Image Logo -->
                <NuxtLink to="/newPage" class="inline-block mr-4 py-0.5 text-xl whitespace-nowrap hover:no-underline focus:no-underline">
                ...
                <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center" id="navbarsExampleDefault">
                    <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                        ...
                        <li class="relativegroup"  @click="isOpen=!isOpen">
                            <button
                            ...
                            <div>
                                <ul v-if="this.dropdown" class="flex lg:absolute flex-col max-w-42 py-1 lg:bg-white rounded-md lg:shadow-md pl-2 lg:pl-0">
                                    <li >
                                        <NuxtLink to="/article" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Article Details</NuxtLink>
                                    </li>
                                    <li>
                                        <Nuxtlink to="/Terms" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Terms Conditions</Nuxtlink>
                                    </li>
                                    <li>
                                        <Nuxtlink to="/Privacy" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100">Privacy Policy</Nuxtlink>
                                    </li>
                        ...
                        <li>
                            ...
                            <NuxtLink to="#download" class="nav-link page-scroll" href="#download">Download</NuxtLink>
                        </li>
                    </ul>
                    <span class="block lg:ml-3.5">
                        <a class="no-underline" href="#your-link">
                            <font-awesome-icon icon="fa-brands fa-apple text-indigo-600 hover:text-pink-500 text-xl transition-all duration-200 mr-1.5" />
                            
                        </a>
                        <a class="no-underline" href="#your-link">
                            <font-awesome-icon icon="fa-brands fa-android text-indigo-600 hover:text-pink-500 text-xl transition-all duration-200"/>
            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                    ...
                    <a class="btn-solid-lg" href="#your-link">
                        <font-awesome-icon icon="fab fa-brands fa-apple" />
                        Download
                    </a>
                    
                    <a class="btn-solid-lg secondary" href="#your-link"><font-awesome-icon icon="fab fa-brands fa-google-play" />Download</a>
                </div>
                <div class="xl:text-right">
                    <img class="inline" src="../assets/img/header-smartphone.png" alt="alternative" />
                </div>
            </div> <!-- end of container -->
            ...
            <div class="container px-4 sm:px-8 xl:px-4">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../assets/img/features-icon-1.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../assets/img/features-icon-2.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../assets/img/features-icon-3.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../assets/img/features-icon-4.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../assets/img/features-icon-5.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="../assets/img/features-icon-6.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
        ...
        <div id="details" class="pt-12 pb-16 lg:pt-16">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-7">
                    <div class="xl:ml-14">
                        <img class="inline" src="../assets/img/details-1.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        </div>
            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                <div class="lg:col-span-7">
                    <div class="mb-12 lg:mb-0 xl:mr-14">
                        <img class="inline" src="../assets/img/details-2.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
                <div class="lg:col-span-5">
                    <div class="xl:mt-12">
                        ...
                        <button class="btn-solid-reg popup-with-move-anim mr-1.5" @click="$refs.modalName.openModal()" >Lightbox</button>
                       
                        <!-- <NuxtLink to="/details-lightbox" class="btn-solid-reg popup-with-move-anim mr-1.5" >Lightbox</NuxtLink> -->
                        <NuxtLink to="/article" class="btn-outline-reg">Details</NuxtLink>
        ...
        <div class="pt-16 pb-12">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                ...
                <div class="lg:col-span-7">
                    <div class="ml-14">
                        <img class="inline" src="../assets/img/details-3.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        </div>
        ...
        <div id="download" class="basic-5">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-2">
                <div class="mb-16 lg:mb-0">
                    <img src="../assets/img/conclusion-smartphone.png" alt="alternative" />
                </div>
                <div class="lg:mt-24 xl:mt-44 xl:ml-12">
                    ...
                    <NuxtLink to="#download" class="btn-solid-lg" href="#your-link"><i class="fab fa-apple"></i>Download</NuxtLink>
                    <NuxtLink to="#download" class="btn-solid-lg secondary" href="#your-link"><i class="fab fa-google-play"></i>Download</NuxtLink>
                </div>
            </div> <!-- end of container -->
        </div> <!-- end of basic-5 -->
        <!-- end of conclusion -->
            ...
            <div class="container px-4 sm:px-8">
                ...
                <div class="social-container">
                    ...
                    <span class="fa-stack">
                        <a href="#your-link">
                            <i class="fas fa-circle fa-stack-2x"></i>
                            <font-awesome-icon icon="fab fa-brands fa-twitter" />
                        </a>
                    </span>
                    <span class="fa-stack">
                        <a href="#your-link">
                    ...
                    <span class="fa-stack">
                        <a href="#your-link">
                            <font-awesome-icon icon="fa-thin fa-circle" />
        ...
        <div class="copyright">
          <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-3">
              <ul class="mb-4 list-unstyled p-small">
                  <li class="mb-2"><NuxtLink to="/article">Article Details</NuxtLink></li>
                  <li class="mb-2"><NuxtLink to="/terms">Terms & Conditions</NuxtLink></li>
                  <li class="mb-2"><NuxtLink to="/privacy">Privacy Policy</NuxtLink></li>
              </ul>
...
export default {
  ...
  methods: {
    ...
    closeModal() {
      this.show = false;
      document.querySelector("Modal").classList.remove("overflow-hidden");
    },
    openModal() {
      this.show = true;
      document.querySelector("Modal").classList.add("overflow-hidden");
    }
...
.cards-2 {
    position: relative;
    padding-top: 8rem;
    background: linear-gradient(rgba(50, 60, 70, 0.9), rgba(50, 60, 70, 0.9)), url("../assets/img/pricing-background.jpg") center center no-repeat;
