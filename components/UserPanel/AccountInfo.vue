    ...
    <div class="mt-30 dark:bg-[#262950] bg-white p-6 rounded-md">
        ...
        <div>
            <div class="flex flex-wrap ">
                <div class="max-lg:w-full w-1/2 pr-4 pl-4">
                    <div class="mb-[30px]">
                        <label for="" class="dark:text-white text-sm text-[#505386] font-semibold mb-0">Recovery Email</label>
                        <input class="dark:border-[rgba(256,256,256,0.1)] dark:text-white bg-transparent h-[60px] border px-5 py-0 border-solid border-[rgba(0,0,0,0.1)]" type="text" placeholder="Recovery Email">
                    </div>
                </div>
                <div class="max-lg:w-full w-1/2 pr-4 pl-4">
                    <div class="mb-[30px]">
                        <label for="" class="dark:text-white text-sm text-[#505386] font-semibold mb-0">Recovery Phone</label>
                        <input class="dark:border-[rgba(256,256,256,0.1)] dark:text-white bg-transparent h-[60px] border px-5 py-0 border-solid border-[rgba(0,0,0,0.1)]" type="text" placeholder="Recovery Phone">
                    </div>
                </div>

                <div class="max-lg:w-full w-1/2 pr-4 pl-4">
                    <div class="mb-[30px]">
                        <label for="" class="dark:text-white text-sm text-[#505386] font-semibold mb-0">Security Question 1</label>
                        <select class="dark:border-[rgba(256,256,256,0.1)] dark:text-white bg-transparent  h-[60px] border px-5 py-0 border-solid border-[rgba(0,0,0,0.1)]" name="" id="">
                            <option value="" disabled selected>What is your favourite color ?</option>
                            <option value="">United State</option>
                        </select>
                    </div>
                </div>
                <div class="max-lg:w-full w-1/2 pr-4 pl-4">
                    <div class="mb-[30px]">
                        <label for="" class="dark:text-white text-sm text-[#505386] font-semibold mb-0">Answer 1</label>
                        <input class="dark:border-[rgba(256,256,256,0.1)] dark:text-white bg-transparent h-[60px] border px-5 py-0 border-solid border-[rgba(0,0,0,0.1)]" type="text" placeholder="Recovery Phone">
                    </div>
                </div>
                <div class="max-lg:w-full w-1/2 pr-4 pl-4">
                    <div class="mb-[30px]">
                        <label for="" class="dark:text-white text-sm text-[#505386] font-semibold mb-0">Security Question 2</label>
                        <select class="dark:border-[rgba(256,256,256,0.1)] dark:text-white bg-transparent h-[60px] border px-5 py-0 border-solid border-[rgba(0,0,0,0.1)]" name="" id="">
                            <option value="" disabled selected>What is your favourite movie ?</option>
                            <option value="">New Work</option>
                        </select>
                    </div>
                </div>
                <div class="max-lg:w-full w-1/2 pr-4 pl-4">
                    <div class="mb-[30px]">
                        <label for="" class="dark:text-white text-sm text-[#505386] font-semibold mb-0">Answer 2</label>
                        <input class="dark:border-[rgba(256,256,256,0.1)] dark:text-white bg-transparent h-[60px] border px-5 py-0 border-solid border-[rgba(0,0,0,0.1)]" type="text" placeholder="Recovery Phone">
                    </div>
                </div>
