                        ...
                        <div class="overflow-hidden bg-white mb-[30px] rounded-[20px]">
                            ...
                            <div class="content flex pt-[30px] pb-[19px] px-[30px]">
                                ...
                                <div class="flex-[1]">
                                    ...
                                    <div>
                                        <h4 class="text-[28px] leading-[38px] font-bold mb-[13px] pt-3">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-wrap mt-[25px]">
                                            ...
                                            <div>
                                                <NuxtLink to="#" class="text-[#333333] after:content-[',']"> Tickets
                                                </NuxtLink>
                                                <NuxtLink to="#" class="text-[#333333] after:content-[',']"> Coming Soon
                                                </NuxtLink>
