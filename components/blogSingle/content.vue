        ...
        <div class="w-full mx-auto px-[15px] sm:max-w-[540px] sm:px-4 md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1170px]">
            <div class="flex flex-wrap ">
                <div class="lg:w-2/3 pr-4 pl-4">
                    <div class="overflow-hidden bg-white mb-[30px] rounded-[20px]">
                        <div>
                        ...
                        <div class="content flex pt-[30px] pb-[19px] px-[30px]">
                            ...
                            <div class="flex-[1]">
                                ...
                                <div>
                                    <h4 class="text-[28px] leading-[38px] font-bold mb-[13px]">
                                    ...
                                    <blockquote class="block p-10 bg-slate-100 my-4 rounded-2xl">
                             ...
                             <span class="text-lg font-semibold text-[#333]">
                                        ...
                                        <div>
                                            <NuxtLink to="#" class="text-[#333333] after:content-[',']"> Tickets </NuxtLink>
                            <NuxtLink to="#" class="text-[#333333] after:content-[',']"> Coming Soon </NuxtLink>
                    ...
                    <div class="bg-white shadow-[0px_10px_5px_0px_rgba(119,123,146,0.02)] p-[30px] rounded-[10px] sm:flex ">
                        ...
                        <div class=" pl-[30px]">
                            <h5 class="uppercase mb-[18px] m-0">
                                <NuxtLink to="#">
                                    Lee Burke
                                </NuxtLink>
                            </h5>
                    ...
                    <div class="mt-10 md:mt-[50px] min-[992px]:mt-20">
                        <h5 class="uppercase text-[22px] pb-[15px] min-[576px]:test-[28px]">comments</h5>
                        <ul>
                            <li class="px-0 py-[21px] border-t-[rgba(0,0,0,0.1)] border-t border-solid sm:flex sm:flex" v-for="index in 3" key="index">
                                <div class=" sm:min-w-min">
                                    ...
                                    <div class="w-[150px] pl-[30px]">
                                        ...
                                        <h6 class="text-base font-semibold uppercase"><NuxtLink to="#">carl morgan</NuxtLink></h6>
                                    </div>
                                </div>
                        ...
                        <div class="mt-5 md:mt-[35px] min-[992px]:mt-[55px]">
                            <h5 class="uppercase text-[22px] pb-[15px] min-[576px]:text-[28px]">leave comment</h5>
                            <form>
                                <div class="mb-4">
                ...
                <div class="lg:w-1/3 pr-4 pl-4">
                    <div
                        class=" mb-8 pt-8 pb-[30px] px-[30px] bg-white shadow-[0px_5px_20px_0px_rgba(78,64,128,0.1)] py-[30px] rounded-[20px]">

                        <h5 class="title">search</h5>
                        <form class="search-form mt-5">
                            <input type="text" placeholder="Enter your Search Content"
                                class="text-sm mb-[30px] pl-0 rounded-none border-b-[rgba(0,0,0,0.15)] border-t-0 border-l-0 border-r-0 border-b border-b-solid focus:border-0 active:border-0 target:border-0 placeholder-[rgb(76,88,143)]"
                                required>
                            <button type="submit"
                                class="w-auto min-w-[130px] h-10 rounded-[20px] border-2 text-black outline-none"><i
                    ...
                    <div
                        ...
                        <h5>categories</h5>
                        <ul class="mt-[9px]">
                            <li class="p-0 border-b-[rgba(0,0,0,0.155)] border-b border-dashed">
                                <NuxtLink to="#"
                                    class="flex flex-wrap justify-between text-[#333333] text-base px-0 pb-1.5 pt-0 hover:text-[#5650ce] no-underline">
                                    <span>Showtimes & Tickets</span><span>50</span>
                                </NuxtLink>
                            </li>
                            <li class="p-0 border-b-[rgba(0,0,0,0.155)] border-b border-dashed">
                                <NuxtLink to="#"
                                    class="flex flex-wrap justify-between text-[#333333] text-base px-0 py-1.5 hover:text-[#5650ce] no-underline">
                            ...
                            <li class="p-0 border-b-[rgba(0,0,0,0.155)] border-b-0 border-dashed">
                                <NuxtLink to="#"
                                    class="flex flex-wrap justify-between text-[#333333] text-base px-0 py-1.5 hover:text-[#5650ce] no-underline">
                    ...
                    <div
                        class="relative mb-8 pt-[31px] pb-[21px] px-[30px] bg-white shadow-[0px_5px_20px_0px_rgba(78,64,128,0.1)] py-[30px] rounded-[20px]">
                        <h5>latest post</h5>
                        <div class="flex flex-wrap py-2">
                            <span
                                class="  hover:text-white hover:bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] hover:bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] block w-5 h-5 leading-5 text-center cursor-pointer text-[10px] bg-[#fafbff] shadow-[0px_2px_5px_0px_rgba(0,18,50,0.2)] text-[#333333] transition-all duration-[ease] delay-[0.3s] rounded-[50%]">&lt;</span>
                            <span
                        ...
                        <div style="display: block;" class="owl-carousel owl-theme">
                            <div>
                                ...
                                <div>
                                    <h6 class="text-lg mb-[7px]">
                                        <NuxtLink to="#" class="overflow-hidden text-ellipsis no-underline">How to
                                            Start, Plan, and Keep a
                                            Date Night</NuxtLink>
                                    </h6>
                                    <div class="flex flex-wrap text-sm">
                                        <NuxtLink to="#" class="mr-4 text-[#333333]"><i
                                        ...
                                        <NuxtLink to="#" class="text-[#333333]"> <i
                    ...
                    <div
                        class="pt-[31px] pb-[30px] px-[30px] mb-8 bg-white shadow-[0px_5px_20px_0px_rgba(78,64,128,0.1)] py-[30px] rounded-[20px] ">
                        <h5>featured tags</h5>
                        <ul class="flex flex-wrap mt-[-5px] mr-[-5px] mb-[-5px] ml-[-5px]">
                            <li class="p-[5px]">
                                <NuxtLink to="#"
                                    class=" hover:bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] hover:bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] hover:text-white text-sm capitalize  border text-[#333] px-[39px] py-1.5 rounded-[20px] border-solid border-[rgba(0,0,0,0.15)] no-underline">
                                    creative</NuxtLink>
                            </li>
                            <li class="p-[5px]">
                                <NuxtLink to="#"
