                    ...
                    <div class="lg:w-3/5 max-lg:w-full pr-4 pl-4 ">
                        <div class="h-[calc(100vh_-_72px)] overflow-y-auto pb-10">
                            ...
                            <div>
                                <form action="#">
                                    <div class="mb-4">
                                        <label for="" class="text-lg leading-7 text-[#3b368c] font-semibold">Your Address</label>
                                        <input type="email" class="border bg-[rgb(234,242,252)] dark:text-white dark:bg-[#262950]   shadow-[1.948px_13.864px_6px_0px_rgba(220,234,251,0.3)] text-base text-[#3b368c] h-[60px] px-[30px] py-0 border-solid border-[rgba(59,54,140,0.1)] placeholder:text-[#3b368c]" placeholder="Enter Your Email">
                                    </div>
                                    <div class="mb-4">
                                        <label for="" class="text-lg leading-7 text-[#3b368c] font-semibold">Password</label>
                                        <input type="text" class="border bg-[rgb(234,242,252)] dark:text-white dark:bg-[#262950]   shadow-[1.948px_13.864px_6px_0px_rgba(220,234,251,0.3)] text-base text-[#3b368c] h-[60px] px-[30px] py-0 border-solid border-[rgba(59,54,140,0.1)] placeholder:text-[#3b368c]" placeholder="Enter Your Password">
                                    </div>
                                    <p class="text-base">
                                    ...
                                    <div class="block text-center">
                                        ...
                                        <NuxtLink to="#" class=" no-underline border bg-[rgb(234,242,252)] dark:bg-[#262950]  shadow-[1.948px_13.864px_6px_0px_rgba(220,234,251,0.3)] transition-all duration-[ease] delay-[0.3s] mt-[9px] mb-[19px] px-[30px] py-2.5 rounded-[50px] border-solid border-[rgba(59,54,140,0.1)] hover:shadow-[2px_13px_16px_0px_rgba(59,54,140,0.1)]"><img src="assets/images/google.png" class="mr-2" alt=""> Sign Up with
                                            Google</NuxtLink>
                                        <p class="text-base">
                                            Don't have an account? <NuxtLink class="text-[#3b368c] font-semibold hover:underline" to="/register">
                                                Sign up here
                                            </NuxtLink>
                                        </p>
                                    </div>
