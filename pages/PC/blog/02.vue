          ...
          <div class="flex flex-wrap ">
              <div class="lg:w-2/3 pr-4 pl-4">
                      ...
                      <div class="content flex pt-[30px] pb-[19px] px-[30px]">
                          <div class="w-10 mr-[30px]">
                              ...
                              <ul class="text-center">
                                  <li class="mb-3">
                                      <NuxtLink to="#" class="block w-[30px] h-[30px] bg-[#f8e9f7] text-center leading-[30px] text-base mx-auto my-0 rounded-[50%] no-underline">
                                          <i class="far fa-comments bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)]"></i>
                                      </NuxtLink>
                                      <span class="font-semibold">30</span>
                                  </li>
                                  <li class="mb-0">
                                      <NuxtLink to="#" class="block w-[30px] h-[30px] bg-[#f8e9f7] text-center leading-[30px] text-base mx-auto my-0 rounded-[50%] no-underline">
                                          <i class="fas fa-share-alt bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)]"></i>
                                      </NuxtLink>
                          ...
                          <div class="flex-[1]">
                              <p class="text-base leading-[26px] mb-[13px]">
                                  December 19, 2021
                              </p>
                              <div>
                                          <h4 class="text-[28px]   dark:text-[white] leading-[38px] font-bold mb-[13px]">
                                              {{ data?.title }}
                                          </h4>
                                          <p class="mb-[18px]">
                                              {{ data?.intro }}
                                          </p>
                                          <blockquote class="block p-10 bg-slate-100 my-4  dark:bg-[#202342] rounded-2xl"
                              ...
                              <div class="flex flex-wrap justify-between mt-[5px]  dark:border-t-[rgba(256,256,256,0.155)]  border-t-[rgba(0,0,0,0.1)] border-t border-solid">
                                  <div class="flex flex-wrap mt-[25px]">
                           <span class="text-lg font-semibold text-[#333]   dark:text-[white]">
                                          Tags :
                                      </span>
                                      <div>
                                          <NuxtLink to="#" class="text-[#333333]  dark:text-[white] after:content-[',']"> Tickets </NuxtLink>
                          <NuxtLink to="#" class="text-[#333333]  dark:text-[white] after:content-[',']"> Coming Soon </NuxtLink>
                  ...
                  <div class="bg-white dark:bg-[#262950] shadow-[0px_10px_5px_0px_rgba(119,123,146,0.02)] p-[30px] rounded-[10px] sm:flex ">
                      ...
                      <div class=" pl-[30px]">
                          <h5 class="  dark:text-[white] uppercase mb-[18px] m-0">
                              <NuxtLink class="dark:text-[white] "  to="#">
                                  Lee Burke
                              </NuxtLink>
                          </h5>
                          <p>
                      ...
                      <ul class="">
                          <li class="px-0 py-[21px]  dark:border-t-[rgba(256,256,256,0.155)]  border-t-[rgba(0,0,0,0.1)] border-t border-solid sm:flex" v-for="index in 3" :key="index">
                              <div class=" sm:min-w-min flex items-center">
                                  ...
                                  <div class="w-[150px] pl-[30px]">
                                      <span class="block text-[#9aace5] text-sm mb-2.5">13 days ago</span>
                                      <h6 class="text-base   dark:text-[white] font-semibold uppercase"><NuxtLink  class="dark:text-[white] " to="#">carl morgan</NuxtLink></h6>
                                  </div>
                              </div>
              ...
              <div class="lg:w-1/3 pr-4 pl-4">
                  ...
                  <div
                      class=" mb-8 pt-8 pb-[30px] px-[30px] bg-white dark:bg-[#262950] shadow-[0px_5px_20px_0px_rgba(78,64,128,0.1)] py-[30px] rounded-[20px]">
                      <h5 class="dark:text-[white]">Newsletter</h5>
                      <form class="mt-5">
                  ...
                  <div
                      class="pt-[31px] pb-[30px] px-[30px] mb-8 bg-white dark:bg-[#262950] shadow-[0px_5px_20px_0px_rgba(78,64,128,0.1)] py-[30px] rounded-[20px] ">
                      <h5 class="dark:text-[white]">featured tags</h5>
                      <ul class="flex flex-wrap mt-[-5px] mr-[-5px] mb-[-5px] ml-[-5px]">
                          <li class="p-[5px]">
                              <NuxtLink to="#"
                                  class=" hover:bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] hover:bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] hover:text-white  text-sm capitalize  border text-[#333] px-[39px] dark:border-[rgba(256,256,256,0.3)] dark:text-[white] py-1.5 rounded-[20px] border-solid border-[rgba(0,0,0,0.15)] no-underline">
                                  creative</NuxtLink>
                          </li>
                          <li class="p-[5px]">
                              <NuxtLink to="#"
                          ...
                          <li class="p-[5px]">
                              <NuxtLink to="#"
                                  class="active bg-[-o-linear-gradient(284deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] bg-[linear-gradient(166deg,rgb(242,40,118)_0%,rgb(148,45,217)_100%)] text-white text-sm capitalize  border px-[39px] py-1.5 rounded-[20px] border-solid border-[rgba(0,0,0,0.15)] no-underline">
                                  landing</NuxtLink>
                          </li>
                      </ul>
                  </div>
...
import img from '@/assets/frontend/images/blog/blogs/02.jpg'
const data = {
    "intro": "Online dating has become a popular way to meet new people and find potential partners. However, navigating the world of online dating can be overwhelming and challenging, especially if you're new to the scene. In this blog post, we'll share some tips on how to navigate the world of online dating.",
    "title": "How to Navigate the World of Online Dating",
    "content": [
        {
            "heading": "Choose the Right Platform",
            "description": "There are many different online dating platforms to choose from, and each has its own unique features and user base. Take the time to research different platforms and choose the one that best fits your preferences and goals. Consider factors such as the age range of users, the type of relationships people are looking for, and the platform's user interface."
        },
        {
            "heading": "Be Honest in Your Profile",
            "description": "Your dating profile is your first impression on potential matches, so it's important to be honest and upfront about who you are and what you're looking for. Avoid exaggerating or lying about anything, as it can lead to disappointment and potentially ruin a relationship before it even starts. Be authentic and showcase your personality and interests."
        },
        {
            "heading": "Be Open-Minded",
            "description": "One of the benefits of online dating is the opportunity to meet people you might not have crossed paths with in real life. Be open-minded when it comes to potential matches and don't limit yourself to specific criteria such as height, occupation, or hobbies. Keep an open mind and be willing to get to know people who may not fit your usual type."
        },
        {
            "heading": "Don't Rush into Things",
            "description": "It's important to take things slow and get to know potential matches before rushing into anything. Avoid sharing personal information such as your home address or phone number until you feel comfortable and have built trust with the person. Take the time to communicate and get to know the person through messages, phone calls, or video chats before meeting in person."
        },
        {
            "heading": "Stay Safe",
            "description": "While online dating can be a fun and exciting way to meet new people, it's important to stay safe. Avoid sharing personal information too soon and always meet in a public place for the first few dates. Trust your instincts and if something feels off, don't be afraid to end the conversation or date."
        }
    ],
    "conclusion": "In conclusion, online dating can be a great way to meet new people and find potential partners. By choosing the right platform, being honest in your profile, being open-minded, taking things slow, and staying safe, you can navigate the world of online dating with confidence and ease. Remember to have fun and enjoy the experience, and you may just find your perfect match."
}
