<template>
  <section class="container">
    <div class="fixed header">
      <i class="material-icons" @click="index = 0"
    ...
    >
      <div v-if="isVisible" class="rounded-borders card card--one">
        <div style="height: 100%">
          <img
            :src="`_nuxt/assets/images/${current.src}`"
    ...
    >
      <div style="height: 100%">
        <img :src="`_nuxt/assets/images/${next.src}`" class="rounded-borders" />
        <div class="text">
          <h2>
    ...
    <div class="footer fixed">
      <div class="btn btn--decline" @click="match">
        <i class="material-icons"
          ><font-awesome-icon icon="fa-solid fa-xmark"
        /></i>
      </div>
      <div class="btn btn--skip" @click="match">
        <i class="material-icons"
