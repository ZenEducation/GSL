...
type EagerBlogYash = {
  readonly [__modelMeta__]: {
    identifier: ManagedIdentifier<BlogYash, 'id'>;
...
export declare type BlogYash = LazyLoading extends LazyLoadingDisabled ? EagerBlogYash : LazyBlogYash

export declare const BlogYash: (new (init: ModelInit<BlogYash>) => BlogYash) & {
  copyOf(source: BlogYash, mutator: (draft: MutableModel<BlogYash>) => MutableModel<BlogYash> | void): BlogYash;
}
